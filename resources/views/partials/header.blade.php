    ...
    <div class="max-w-6xl mx-auto px-4">
        <div class="flex justify-between">
               ...
               <div class="hidden md:flex items-center space-x-1">
                    <a href="{{route('editdata')}}" class="{{ (request()->is('editdata')) ? 'border-b-4' : '' }} py-4 px-2 text-gray-500 border-purple-500 font-semibold">
                        Editing
                    </a>
                    <a href="#" onclick="downloadExcelSheet()" class="py-4 px-2 text-gray-500 border-purple-500 font-semibold">
                        Report
                    </a>
                    <a href="{{route('reupload')}}" class="{{ (request()->is('reupload')) ? 'border-b-4' : '' }} py-4 px-2 text-gray-500 border-purple-500 font-semibold">
                        Reupload
                    </a>
                    <a href="{{route('home')}}" class="{{ (request()->is('home')) ? 'border-b-4' : '' }} py-4 px-2 text-gray-500 border-purple-500 font-semibold">
                        Upload
                    </a>
                    <a href="{{route('save')}}" class="{{ (request()->is('save')) ? 'border-b-4' : '' }} py-4 px-2 text-gray-500 font-semibold hover:text-purple-500 transition duration-300">
                        Save
                    </a>
                    {{ (request()->is('save')) ? 'active' : '' }}
